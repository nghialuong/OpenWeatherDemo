...
- Being devided in 3 layers:
    ...
    - Platform Layer = Repositories Implementations + API (Network) + [Caching](https://www.swiftbysundell.com/articles/caching-in-swift/)
...
c/ Run `pod install` in project directory, run project by `OpenWeatherDemo.xcworkspace` file. 
